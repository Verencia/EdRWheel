...
// Show histo[id,%,cheatCount,trueCount,text,bool]
      ...
      for (let index2 = 0; index2 < resultsHisto.length; index2+=3) {
        if (histoCount == parseInt(resultsHisto[index2])) {
          ...
          if (resultsHisto[index2+1]!=undefined) {
            pResultChosen.innerText = resultsHisto[index2+2];
          }else {
...
function hideGames() {
  ...
  if (gamesHidden) {
    ...
    titleOpt.classList.remove("pt-1","mt-14");
    ...
    titleOpt.classList.add("pt-1","mt-14");
...
function hideHisto() {
  ...
  if (histoHidden) {
    ongletHisto.classList.remove("pb-4","rounded-tl-lg","pt-1");
...
function ongletHistoClicked() {
  ...
  if (!ongletHistoActive) {
    ...
    resumeSession.classList.remove("showContent");
...
function ongletResumeClicked() {
  ...
  if (!ongletResumeActive) {
    ...
    resumeSession.classList.add("showContent");
